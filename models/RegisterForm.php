...
class RegisterForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            // обязательное присутствие хотя бы одной буквы в верхнем и нижнем регистре
            // ['password', 'match', 'pattern' => '/^(?=.*[A-Z])(?=.*[a-z]).+$/'],

            // обязательное присутствие хотя бы одной буквы в верхнем и нижнем регистре + цифра
            // ['password', 'match', 'pattern' => '/^(?=.*[\d])(?=.*[A-Z])(?=.*[a-z]).+$/'],

            // пароль - латинский алфавит, цифры, обязательное присутствие хотя бы одной буквы в верхнем и нижнем регистре + цифра 
            // ['password', 'match', 'pattern' => '/^(?=.*[\d])(?=.*[A-Z])(?=.*[a-z])[a-zA-Z\d]+$/'],
